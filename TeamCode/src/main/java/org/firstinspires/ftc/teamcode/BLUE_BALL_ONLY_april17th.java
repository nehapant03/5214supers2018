...
@Autonomous(name="BLUE_BALL_ONLY_april17th", group="Team5214")
//@Disabled

public class BLUE_BALL_ONLY_april17th extends LinearOpMode{
...
//    ColorSensor colorBack;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (colorid == "BLUE"){FLICKSERVO(0.2);
            }else if(checkColor(colorFront,.4) == "RED"){FLICKSERVO(.8);}
