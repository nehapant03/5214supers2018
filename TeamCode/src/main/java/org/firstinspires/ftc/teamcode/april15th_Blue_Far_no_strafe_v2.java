...
@Autonomous(name="april15th_Blue_Far_no_strafe_v2", group="Team5214")
//@Disabled
public class april15th_Blue_Far_no_strafe_v2 extends LinearOpMode{
...
//            keyResult = "LEFT";
            ...
            switch (keyResult) {
                ...
                case "CENTER":
                    ...
                    straightWithEncoder(0.5, 10);
                    leftDump.setPosition(.61);
                    turnLeftDegress(28, parameters);

                    leftPush.setPosition(.5);
                    rightPush.setPosition(.5);
                    straightWithEncoder(0.6, -14);
                    sleep(300);
