...
@TeleOp(name="HOUSTON_Manual_v6", group="Team5214")
//@Disabled
public class HOUSTON_Manual_v6 extends LinearOpMode {
    ...
    private boolean elevatorDown = true;
...
//            }
        ...
        */
            ...
            */
            ...
            else if(gamepad2.dpad_left) {relicMotor.setPower(.2);}
...
//            }
                ...
                motorWithEncoder(relicMotor,.9,-41);
